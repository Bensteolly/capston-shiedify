...
const Questions = () => {
    return (
        <div className="max-w-full sm:max-w-[640px] md:max-w-[768px] lg:max-w-[1024px] xl:max-w-[1272px] mt-[100px] mx-auto py-11 bg-[#B3BCD5] rounded-2xl">
            <div className="flex items-center justify-center">
                <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl">Do you have questions?</h1>
