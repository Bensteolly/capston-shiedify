            ...
            <div className="w-full max-w-[800px] mx-auto sm:my-[150px] flex-row bg-[#E3E5E7] rounded-md overflow-hidden box-border sm:flex shadow-2xl">
                ...
                <div className=" w-full mx-auto self-center sm:ml-8">
                    <form onSubmit={signUp}>
                        ...
                        <button type="submit" className='bg-[#09122B] text-white w-full max-w-[145px] h-full max-h-12 rounded-lg p-4 font-bold text-center text-sm my-6 mx-[150px] sm:text-3xl pt-8'  >SIGN UP</button>
                    </form>
